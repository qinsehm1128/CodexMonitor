  ...
  const tcpRunnerStatusText = (() => {
    ...
    if (tcpDaemonStatus.state === "running") {
      return tcpDaemonStatus.pid
        ? t("settings.server.runnerRunningPid", {
            pid: tcpDaemonStatus.pid,
            listenAddr: tcpDaemonStatus.listenAddr ?? "configured listen address",
          })
        : t("settings.server.runnerRunning", {
            listenAddr: tcpDaemonStatus.listenAddr ?? "configured listen address",
          });
    }
    if (tcpDaemonStatus.state === "error") {
      return tcpDaemonStatus.lastError ?? t("settings.server.runnerError");
    }
    return t("settings.server.runnerStopped", {
    ...
    >
      ...
      {!isMobileSimplified && (
        <div className="settings-field">
          ...
          <div className="settings-help">{t("settings.server.backendModeHelp")}</div>
        </div>
      )}
      ...
      <>
        {isMobileSimplified && (
          <>
            <div className="settings-field">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="settings-mobile-remote-actions">
                        ...
                        >
                          {t("settings.server.deleteRemoteConfirm")}
                        </button>
                      </div>
                    </div>
                  );
              ...
              <div className="settings-help">{t("settings.server.activeRemoteHelp")}</div>
            </div>
        ...
        {!isMobileSimplified && (
          <SettingsToggleRow
            title={t("settings.server.keepDaemonRunningTitle")}
        ...
        {isMobileSimplified && (
          <div className="settings-field">
            ...
            <div className="settings-help">{t("settings.server.connectionTestHelp")}</div>
          </div>
        )}
        ...
        {!isMobileSimplified && (
          <div className="settings-field">
            ...
            {tcpDaemonStatus?.startedAtMs && (
              <div className="settings-help">
                {t("settings.server.daemonStartedAt", {
                  value: new Date(tcpDaemonStatus.startedAtMs).toLocaleString(),
                })}
              </div>
            )}
            <div className="settings-help">{t("settings.server.daemonHelp")}</div>
          </div>
        )}
        ...
        {!isMobileSimplified && (
          <div className="settings-field">
            ...
            <div className="settings-field-row">
              ...
              >
                {tailscaleStatusBusy ? t("settings.server.refreshing") : t("settings.server.detectTailscale")}
              </button>
              <button
                type="button"
                className="button settings-button-compact"
              ...
              <>
                ...
                <div className="settings-help">
                  {tailscaleStatus.installed
                    ? t("settings.server.tailscaleVersion", {
                        value: tailscaleStatus.version ?? "unknown",
                      })
                ...
                {tailscaleStatus.suggestedRemoteHost && (
                  <div className="settings-help">
                    {t("settings.server.suggestedRemoteHost", {
                      value: tailscaleStatus.suggestedRemoteHost,
                    })}
                  </div>
                )}
                {tailscaleStatus.tailnetName && (
                  <div className="settings-help">
                    {t("settings.server.tailnet", { value: tailscaleStatus.tailnetName })}
                  </div>
                )}
              </>
            )}
      ...
      {addRemoteOpen && (
        <ModalShell
          ...
          ariaLabel={t("settings.server.addRemoteTitle")}
        >
          <div className="settings-add-remote-header">
            <div className="settings-add-remote-title">{t("settings.server.addRemoteTitle")}</div>
            <button
              type="button"
      ...
      {pendingDeleteRemote && (
        <ModalShell
          ...
          ariaLabel={t("settings.server.deleteRemoteTitle")}
        >
