      ...
      <div className="sidebar-header-title">
        <div className="sidebar-title-group">
          <button
            ...
            aria-label={t("app.sidebar.header.addWorkspaces")}
            data-tooltip={t("app.sidebar.header.addWorkspaces")}
          ...
          <button
            ...
            data-tauri-drag-region="false"
            aria-label={t("app.sidebar.header.openHome")}
          >
            {t("app.sidebar.header.projects")}
          </button>
        </div>
      </div>
      <div className="sidebar-header-actions">
        <div className="sidebar-sort-menu" ref={sortMenuRef}>
          <MenuTrigger
            ...
            data-tauri-drag-region="false"
            aria-label={t("app.sidebar.header.organizeAndSortThreads")}
            title={t("app.sidebar.header.organizeAndSortThreads")}
            data-tooltip={t("app.sidebar.header.organizeAndSortThreads")}
          ...
          {sortMenuOpen && (
            ...
            >
              <div className="sidebar-sort-section-label">{t("app.sidebar.header.organize")}</div>
              <PopoverMenuItem
              ...
              >
                {t("app.sidebar.header.byProject")}
              </PopoverMenuItem>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
              ...
              >
                {t("app.sidebar.header.byProjectActivity")}
              </PopoverMenuItem>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
              ...
              >
                {t("app.sidebar.header.threadList")}
              </PopoverMenuItem>
              <div className="sidebar-sort-divider" aria-hidden />
              <div className="sidebar-sort-section-label">{t("app.sidebar.header.sortBy")}</div>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={t("app.sidebar.header.refreshAllWorkspaceThreads")}
          type="button"
          title={t("app.sidebar.header.refreshAllWorkspaceThreads")}
          data-tooltip={t("app.sidebar.header.refreshAllWorkspaceThreads")}
          data-tooltip-align="end"
          data-tooltip-placement="bottom"
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={t("app.sidebar.header.toggleSearch")}
          data-tooltip={isSearchOpen ? t("app.sidebar.header.closeSearch") : t("app.sidebar.header.searchThreads")}
          data-tooltip-align="end"
          data-tooltip-placement="bottom"
