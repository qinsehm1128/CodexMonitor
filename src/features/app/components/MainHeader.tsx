          ...
          {disableBranchMenu ? (
            <div className="workspace-branch-static-row" ref={infoRef}>
              <MenuTrigger
                ...
                title={t("app.mainHeader.worktreeInfo")}
              >
                ...
                <PopoverSurface className="worktree-info-popover" role="dialog">
                  {worktreeRename && (
                    <div className="worktree-info-rename">
                      <span className="worktree-info-label">{t("app.mainHeader.name")}</span>
                      <div className="worktree-info-command">
                        ...
                        <button
                          ...
                          aria-label={t("app.mainHeader.confirmRename")}
                          title={t("app.mainHeader.confirmRename")}
                        >
                          <Check aria-hidden />
                        </button>
                      </div>
                      ...
                      {worktreeRename.upstream && (
                        <div className="worktree-info-upstream">
                          <span className="worktree-info-subtle">
                            {t("app.mainHeader.updateUpstreamQuestion", {
                          ...
                          >
                            {t("app.mainHeader.updateUpstream")}
                          </button>
                  ...
                  <div className="worktree-info-title">{t("app.mainHeader.worktree")}</div>
                  <div className="worktree-info-row">
                    <span className="worktree-info-label">
                      {t("app.mainHeader.terminal")}{parentPath ? " (repo root)" : ""}
                    </span>
                    <div className="worktree-info-command">
                      ...
                      <button
                        ...
                        data-tauri-drag-region="false"
                        aria-label={t("app.mainHeader.copyCommand")}
                        title={t("app.mainHeader.copyCommand")}
                      >
                        <Copy aria-hidden />
                      </button>
                    </div>
                    <span className="worktree-info-subtle">
                      {t("app.mainHeader.openWorktreeInTerminal")}
                    </span>
                  </div>
                  <div className="worktree-info-row">
                    <span className="worktree-info-label">{t("app.mainHeader.reveal")}</span>
                    <button
                      type="button"
                  ...
                  <div className="branch-actions">
                    <div className="branch-search">
                      <input
                        ...
                        placeholder={t("app.mainHeader.searchOrCreateBranch")}
                        ...
                        autoFocus
                        data-tauri-drag-region="false"
                        aria-label={t("app.mainHeader.searchBranches")}
                      />
                      <button
                        type="button"
                    ...
                    {canCreate && !branchValidationMessage && (
                      <div className="branch-create-hint">
                        {t("app.mainHeader.createBranchHint", { name: trimmedQuery })}
                      </div>
                    )}
                  </div>
                  <BranchList
                    ...
                    emptyText={t("app.mainHeader.noBranchesFound")}
      ...
      <div className="main-header-actions">
        ...
        {showTerminalButton && (
          <button
            ...
            data-tauri-drag-region="false"
            aria-label={t("app.mainHeader.toggleTerminalPanel")}
            title={t("app.mainHeader.terminalButton")}
            data-tooltip={t("app.mainHeader.terminalButton")}
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={t("app.mainHeader.copyThread")}
          title={t("app.mainHeader.copyThread")}
          data-tooltip={t("app.mainHeader.copyThread")}
          data-tooltip-placement="bottom"
        >
